...
public class ModelTest {
    ...
    @Test
    void モデルの管理する時刻データが時間経過とともに増えるかテスト() throws IOException {
    ...
    @Test
    void モデルがタイプされた文字を保持しているかテスト() throws IOException {
        Model model = new Model();
...
//    @Test
//    void ESCキーで同時押しモードが切り替えられるかテスト() throws IOException {
//        Model model = new Model();
//        View view = model.getView();
//        Controller controller = model.getController();
//        
...
//    
//    @Test
//    void キーで同時押しを検出できるかテスト() throws IOException {
//        Model model = new Model();
//        View view = model.getView();
//        Controller controller = model.getController();
//        
